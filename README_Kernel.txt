...
1. How to Build
        ...
        - to Build
                $ export ARCH=arm64
                $ make -C $(pwd) O=$(pwd)/out DTC_EXT=$(pwd)/tools/dtc CONFIG_BUILD_ARM64_DT_OVERLAY=y CLANG_TRIPLE=aarch64-linux-gnu- beyond1qlte_jpn_kdi_defconfig
...
3. How to Clean
        ...
        EX) /home/dpi/qb5_8814/workspace/P4_1716/android/out/target/product/beyond1qltekdi/out
        $ make clean
################################################################################
